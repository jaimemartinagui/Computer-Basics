...
This format conversion can be done with the `convert_to_twos_complement_format` function in the `binary_subtraction.py` module. The input values of the `general_subtractor` must be in this format.
